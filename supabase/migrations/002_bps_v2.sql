...
insert into public.locations (name, name_key, location_group, is_preset) values
  ('Downtown Minneapolis', 'downtown minneapolis', 'minneapolis', true),
  ('North Loop', 'north loop', 'minneapolis', true),
  ('Northeast Minneapolis', 'northeast minneapolis', 'minneapolis', true),
  ('Uptown', 'uptown', 'minneapolis', true),
  ('Lyn-Lake', 'lyn lake', 'minneapolis', true),
  ('Whittier', 'whittier', 'minneapolis', true),
  ('Dinkytown', 'dinkytown', 'minneapolis', true),
  ('Seward', 'seward', 'minneapolis', true),
  ('Longfellow', 'longfellow', 'minneapolis', true),
  ('Nokomis', 'nokomis', 'minneapolis', true),
  ('Linden Hills', 'linden hills', 'minneapolis', true),
  ('Cedar-Riverside', 'cedar riverside', 'minneapolis', true),
  ('North Minneapolis', 'north minneapolis', 'minneapolis', true),
  ('Downtown St. Paul', 'downtown st paul', 'saint-paul', true),
  ('Grand Avenue', 'grand avenue', 'saint-paul', true),
  ('Cathedral Hill', 'cathedral hill', 'saint-paul', true),
  ('Highland Park', 'highland park', 'saint-paul', true),
  ('Macalester-Groveland', 'macalester groveland', 'saint-paul', true),
  ('West Seventh', 'west seventh', 'saint-paul', true),
  ('Como', 'como', 'saint-paul', true),
  ('St. Anthony Park', 'st anthony park', 'saint-paul', true),
  ('St. Louis Park', 'st louis park', 'inner-ring', true),
  ('Richfield', 'richfield', 'inner-ring', true),
  ('Edina', 'edina', 'inner-ring', true),
  ('Golden Valley', 'golden valley', 'inner-ring', true),
  ('Hopkins', 'hopkins', 'inner-ring', true),
  ('Roseville', 'roseville', 'inner-ring', true),
  ('Falcon Heights', 'falcon heights', 'inner-ring', true),
  ('Columbia Heights', 'columbia heights', 'inner-ring', true),
  ('Fridley', 'fridley', 'inner-ring', true),
  ('Brooklyn Center', 'brooklyn center', 'inner-ring', true),
  ('Maplewood', 'maplewood', 'inner-ring', true),
  ('West St. Paul', 'west st paul', 'inner-ring', true),
  ('South St. Paul', 'south st paul', 'inner-ring', true),
  ('Mendota Heights', 'mendota heights', 'inner-ring', true),
  ('Bloomington', 'bloomington', 'greater-metro', true),
  ('Eden Prairie', 'eden prairie', 'greater-metro', true),
  ('Minnetonka', 'minnetonka', 'greater-metro', true),
  ('Plymouth', 'plymouth', 'greater-metro', true),
  ('Maple Grove', 'maple grove', 'greater-metro', true),
  ('Brooklyn Park', 'brooklyn park', 'greater-metro', true),
  ('Eagan', 'eagan', 'greater-metro', true),
  ('Burnsville', 'burnsville', 'greater-metro', true),
  ('Apple Valley', 'apple valley', 'greater-metro', true),
  ('Lakeville', 'lakeville', 'greater-metro', true),
  ('Savage', 'savage', 'greater-metro', true),
  ('Prior Lake', 'prior lake', 'greater-metro', true),
  ('Shakopee', 'shakopee', 'greater-metro', true),
  ('Chanhassen', 'chanhassen', 'greater-metro', true),
  ('Wayzata', 'wayzata', 'greater-metro', true),
  ('Woodbury', 'woodbury', 'greater-metro', true),
  ('Cottage Grove', 'cottage grove', 'greater-metro', true),
  ('Inver Grove Heights', 'inver grove heights', 'greater-metro', true),
  ('Blaine', 'blaine', 'north-metro', true),
  ('Coon Rapids', 'coon rapids', 'north-metro', true),
  ('Anoka', 'anoka', 'north-metro', true),
  ('White Bear Lake', 'white bear lake', 'north-metro', true),
  ('Stillwater', 'stillwater', 'north-metro', true)
